...
const IcAdminRejected = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3000/adminDesignRejected"
      );
  ...
  return (
    <Box m="20px">
      <Header title="IC DESIGN PROVIDER FIRM PROFILE" subtitle="Here Are The Rejected Profiles" />
      <Box
        m="40px 0 0 0"
        height="75vh"
        sx={{
...
export default IcAdminRejected;
