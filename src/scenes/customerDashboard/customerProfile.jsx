    ...
    const handleUpdateProfile = async () => {
      try {
        const response = await axios.put(
          `http://localhost:3000/updateCustomerUser`,
          updatedProfile
        );
        setProfile(response.data);
        setIsDialogOpen(false);
              ...
              <Box display="flex" alignItems="center">
                ...
                <Box display="flex" ml="20px" flexDirection="column" p="20px">
                  ...
                  <Typography variant="h4" color={colors.grey[300]}>
                    Role : {profile.role_id === 2 ? "Customer" : profile.role_id}
                  </Typography>
                  <Typography variant="h4" color={colors.grey[300]}>
                    ID : {profile.user_id}
                  </Typography>
                  ...
                  <Typography variant="h5" color={colors.grey[100]} mt="6px">
                    Existing Cients : {profile.existing_clients}
                  </Typography>
                  <Typography variant="h5" color={colors.grey[100]} mt="6px">
        ...
        <Dialog open={isDialogOpen} onClose={handleCloseDialog}>
          ...
          <DialogContent>
            ...
            <TextField
              ...
              label="Exisitng Clients"
              type="text"
              fullWidth
              value={updatedProfile.existing_clients}
              onChange={handleInputChange}
            />
            <TextField
              margin="dense"
